...
tabsContainer.addEventListener('click', function (e) {
  ...
  // Guard clause
  // este metoda noua de a scrie asta :
  // if(clicked) {
  //    do this code below
  // }
  if (!clicked) return;
...
// to see all the carousel visible mean working on him
...
// acest eveniment nu asteapta imaginile si alte de genu sa se incarce
document.addEventListener('DOMContentLoaded', function (e) {
  console.log('HTML parsed and DOM tree built!', e);
})

// se intampla cand css si js toate s-au incarcat pana la final
window.addEventListener('load', function (e) {
  console.log('PAge fully loaded', e);
})

// se intampla inainte ca user-ul sa faca click pe buttonul de x din tab-ul browser-ului
window.addEventListener('beforeunload', function (e) {
  console.log('before leaving the page', e);
  e.preventDefault();
  e.returnValue = '';
});

// fetch = downloaded and executed
